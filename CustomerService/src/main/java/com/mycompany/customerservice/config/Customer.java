...
public class Customer implements Serializable {
    ...
    public Customer(Integer customerId, String email, String name, int rating, String address, String phoneNo) {
        this.customerId = customerId;
        this.email = email;
        this.name = name;
        this.rating = rating;
    ...
    public String toString() {
        return "com.mycompany.customerservice.config.Customer[ customerId=" + customerId + " ]";
    }
